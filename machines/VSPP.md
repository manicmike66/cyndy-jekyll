...
<div class="row my-4">
<div class="col-6 text-right"> <img class="img-fluid" alt="pivot point of the shuttle driver Singer" src="{{"pic/VSPP.f128K.jpg"}}" width="400" height="320"> </div><!-- end l col -->
...
<div class="row my-4">
<div class="col-6 text-right"><img class="img-fluid" alt="pivot point of the shuttle driver Gritzner" src="{{"pic/VSPP.fGS1.jpg"}}" width="400" height="320"></div><!-- end l col -->
<div class="col-6 vertical-center"> Gritzner circa early 1930s. Like most German made VS models, it conforms to the Singer standard </div><!-- end r col -->
</div><!-- end row -->
...
<div class="row my-4">
<div class="col-6 text-right"> <p><img alt="pivot point of the shuttle driver Wertheim " class="img-fluid" src="{{"pic/VSPP.fWP2.jpg"}}" width="400" height="210"></p> </div><!-- end l col -->
<div class="col-6 vertical-center">
