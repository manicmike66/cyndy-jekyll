var Toolbar='<DIV ID="Toolbar" class="tbToolbar" NOWRAP><table border=0 align="center"><tr><!-- TB_ITEMS --></tr></table></DIV><!-- TB_SUBITEMS -->'
...
function addMenuItem(p,id,caption,turl,hint) {
	var tmpTag='<!-- TBS_'+p+' -->'
	Toolbar=Toolbar.replace(tmpTag,'<DIV id="TBSI_'+id+'" class="tbSubItemLink" onmouseover="showSelect(\''+id+'\',\''+hint+'\')" onmouseup="location=root+\''+turl+'\'" NOWRAP>'+caption+'</div>'+tmpTag)
}
